...
//   - Removed the empty `Reviews` placeholder + stack<Reviews> member.
//     (Out of scope for this iteration; project proposal does not require it.)
...
private:
    ...
    string features;
    string mainImageURL;
    double rating;          // NEW: average customer rating, 0.0 - 5.0
